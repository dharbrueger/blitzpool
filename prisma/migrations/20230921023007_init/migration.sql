...
-- AddForeignKey
ALTER TABLE "Pool" ADD CONSTRAINT "Pool_typeId_fkey" FOREIGN KEY ("typeId") REFERENCES "PoolType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Pool" ADD CONSTRAINT "Pool_commissionerId_fkey" FOREIGN KEY ("commissionerId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
